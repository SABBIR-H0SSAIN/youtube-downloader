...
import AudioDOwnloadPreviewCard from "@/components/AudioDownloadPreviewCard";
    ...
    <div className="py-6 px-8 max-w-7xl mx-auto ">
      <div className="flex flex-col items-center justify-center gap-4">
        <div className="w-full ">
          <h1 className="text-3xl font-bold text-center">Audio Download</h1>
          <p className="text-sm text-muted-foreground text-center">
            Extract and download audio from any youtube video.
          </p>
        </div>
        <form action={action}>
